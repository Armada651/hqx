...
#define PIXEL12_C   Interp0(dp+dpL+2, w[5]);
...
#define PIXEL20_C   Interp0(dp+dpL+dpL, w[5]);
...
#define PIXEL21_C   Interp0(dp+dpL+dpL+1, w[5]);
...
#define PIXEL22_C   Interp0(dp+dpL+dpL+2, w[5]);
...
HQX_API void HQX_CALLCONV hq3x_32_lut( int pattern, uint32_t * dp, int dpL, const uint32_t w[10] )
{
    switch (pattern)
    {
        case 0:
